...
updateTask REPROGRAMMER un RDV « du <ancienne date-heure> au <nouvelle> » ou « de <ancienne heure> à <nouvelle> » : la 1re date-heure IDENTIFIE le RDV existant -> mets-la dans "fromISO" (ISO, au niveau racine à côté de title) pour choisir le bon RDV s'il y en a plusieurs ; la 2de est la NOUVELLE échéance -> changes.due/dueISO. JAMAIS un événement multi-jours ni une plage, JAMAIS de date dans changes.category ; title = le mot-clé du RDV ("coiffeur"), jamais la date. Ex. "Déplace le rendez-vous coiffeur du 7 juillet au 8 juillet de 8h15 à 9h30." -> {"tool":"updateTask","title":"coiffeur","fromISO":"2026-07-07T08:15","changes":{"due":"8 juillet 9h30","dueISO":"2026-07-08T09:30"}}
...
updateTask RESCHEDULE an appointment "from <old date-time> to <new>" or "from <old time> to <new>": the 1st date-time IDENTIFIES the existing appointment -> put it in "fromISO" (ISO, at the root next to title) to pick the right appointment if there are several; the 2nd is the NEW due -> changes.due/dueISO. NEVER a multi-day event or range, NEVER a date in changes.category; title = the appointment keyword ("hairdresser"), never the date. Ex. "Move the hairdresser appointment from July 7 to July 8, from 8:15 to 9:30." -> {"tool":"updateTask","title":"hairdresser","fromISO":"2026-07-07T08:15","changes":{"due":"July 8 9:30","dueISO":"2026-07-08T09:30"}}
