...
const FR = {
  ...
  // ── Anti-sèche ────────────────────────────────────────────────────
  settingsAntiseche: "Anti-sèche",
  settingsAntisecheSub:
    "Fiches préparées, soufflées dans l'oreillette. Rien n'est enregistré.",
  settingsAntisecheOpen: "Préparer une fiche",
  antisecheTitle: "Anti-sèche",
  antisecheClose: "Fermer",
  antisecheBack: "Retour",
  antisecheIntro:
    "Préparez vos points AVANT le rendez-vous. Pendant l'entretien, un appui lit le point suivant dans votre oreillette. Kairos n'écoute personne et n'envoie rien.",
  antisecheSheets: "Fiches",
  antisecheNoSheet: "Aucune fiche pour l'instant.",
  antisecheNewSheet: "Nouvelle fiche",
  antisechePickTask: "Choisir un rendez-vous",
  antisecheNoTask: "Aucune tâche ouverte à laquelle attacher une fiche.",
  antisechePoints: "Points",
  antisecheNoPoint: "Aucun point. Ajoutez-en un ci-dessous.",
  antisecheAdd: "Ajouter",
  antisecheAddPlaceholder: "Nouveau point…",
  antisecheImportNote: "Importer la note de la tâche",
  antisecheStart: "Démarrer la séance",
  antisecheStartShort: "Démarrer",
  antisechePointCount: (n: number) => (n > 1 ? `${n} points` : `${n} point`),
  antisecheEnd: "Terminer",
  antisecheEmpty: "Fiche vide.",
  antisecheTapNext: "Appuyez pour le point suivant",
  antisechePrev: "Précédent",
  antisecheNext: "Suivant",
  antisecheRepeat: "Relire",
  antisecheRouteBluetooth: "Oreillette Bluetooth · lecture vocale active",
  antisecheRouteWired: "Écouteur filaire · lecture vocale active",
  antisecheRouteSpeaker:
    "HAUT-PARLEUR — lecture muette. Connectez votre oreillette.",
  antisecheRouteUnknown:
    "Sortie audio inconnue (rebuild requis) — lecture muette.",
  antisecheRouteAssumed: "Oreillette confirmée par vous · lecture vocale active",
  antisecheVouch: "Je confirme que mon oreillette est connectée",
...
const EN: Strings = {
  ...
  // ── Crib sheet ────────────────────────────────────────────────────
  settingsAntiseche: "Crib sheet",
  settingsAntisecheSub:
    "Prepared notes, read into your earpiece. Nothing is recorded.",
  settingsAntisecheOpen: "Prepare a sheet",
  antisecheTitle: "Crib sheet",
  antisecheClose: "Close",
  antisecheBack: "Back",
  antisecheIntro:
    "Prepare your points BEFORE the meeting. During it, one tap reads the next point into your earpiece. Kairos listens to no one and sends nothing.",
  antisecheSheets: "Sheets",
  antisecheNoSheet: "No sheet yet.",
  antisecheNewSheet: "New sheet",
  antisechePickTask: "Choose an appointment",
  antisecheNoTask: "No open task to attach a sheet to.",
  antisechePoints: "Points",
  antisecheNoPoint: "No point yet. Add one below.",
  antisecheAdd: "Add",
  antisecheAddPlaceholder: "New point…",
  antisecheImportNote: "Import the task's note",
  antisecheStart: "Start session",
  antisecheStartShort: "Start",
  antisechePointCount: (n: number) => (n > 1 ? `${n} points` : `${n} point`),
  antisecheEnd: "Finish",
  antisecheEmpty: "Empty sheet.",
  antisecheTapNext: "Tap for the next point",
  antisechePrev: "Previous",
  antisecheNext: "Next",
  antisecheRepeat: "Repeat",
  antisecheRouteBluetooth: "Bluetooth earpiece · speaking enabled",
  antisecheRouteWired: "Wired earphone · speaking enabled",
  antisecheRouteSpeaker: "LOUDSPEAKER — silent. Connect your earpiece.",
  antisecheRouteUnknown: "Unknown audio output (rebuild required) — silent.",
  antisecheRouteAssumed: "Earpiece confirmed by you · speaking enabled",
  antisecheVouch: "I confirm my earpiece is connected",
