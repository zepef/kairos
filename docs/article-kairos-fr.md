...
- **Une ontologie ré-ancrée à chaque requête, pour compenser l'absence de raisonnement.** Puisqu'on a coupé la réflexion, on évite au modèle d'avoir à *déduire* son contexte : on le lui réinjecte **frais à chaque commande**. Le squelette d'intentions (outils + dimensions + vocabulaire) est fixe, mais à chaque appel on y greffe automatiquement l'**état courant** — la **date et l'heure du moment** (pour résoudre « demain », « vendredi 9 h ») et la **liste numérotée des tâches affichées** (pour résoudre « la 2 »). Cette mise à jour automatique du contexte **pallie l'absence de raisonnement** : le modèle n'a plus qu'à *traduire* la phrase, jamais à *raisonner* sur le temps ou sur l'état de l'application.
